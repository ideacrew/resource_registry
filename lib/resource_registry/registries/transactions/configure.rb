  ...
  module Registries
    module Transactions
      class Configure
        ...
        step :validate_application_config, with: 'resource_registry.registries.validate'
        step :load_application_config

        # step :set_application_load_paths
        
        step :validate_resource_registry_config, with: 'resource_registry.registries.validate'
