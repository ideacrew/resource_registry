...
RSpec.describe ResourceRegistry::Validation::Enterprises::EnterpriseContract do
  ...
  describe 'EnterpriseContract parameters' do
    ...
    context "with invalid parameters" do
      ...
      it { expect(subject.call(optional_params).errors.messages).to eq error_hash }
    end
    ...
    describe "Tenant parameters" do
      ...
      context "with all Enterprise params and invalid nested Tenant params" do
        let(:nested_invalid_tenants)                { { tenants: [{ owner_account: "mary@example.com" }] } }
