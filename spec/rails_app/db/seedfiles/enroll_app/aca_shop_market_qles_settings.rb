Repo.namespace(:aca_shop_market_qles) do
  ...
  register(:new_eligibility_family,
                  {
  ...
  register(:new_eligibility_member,
                  {
  ...
  register(:exceptional_circumstances,
                  {
